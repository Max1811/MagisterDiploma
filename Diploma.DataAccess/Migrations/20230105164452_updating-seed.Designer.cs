...
namespace Diploma.DataAccess.Migrations
{
    ...
    [Migration("20230105164452_updating-seed")]
            ...
            modelBuilder.Entity("Diploma.DataAccess.Entities.AuthorType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 1, 5, 18, 44, 52, 363, DateTimeKind.Local).AddTicks(2640),
                            Type = "Студент",
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 1, 5, 18, 44, 52, 363, DateTimeKind.Local).AddTicks(2644),
                            Type = "Викладач",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("Diploma.DataAccess.Entities.ConferenceType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 1, 5, 18, 44, 52, 363, DateTimeKind.Local).AddTicks(2656),
                            Type = "Всеукраїнська",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 1, 5, 18, 44, 52, 363, DateTimeKind.Local).AddTicks(2659),
                            Type = "Регіональна",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2023, 1, 5, 18, 44, 52, 363, DateTimeKind.Local).AddTicks(2660),
                            Type = "Міжнародна",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("Diploma.DataAccess.Entities.PublicationType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 1, 5, 18, 44, 52, 363, DateTimeKind.Local).AddTicks(2593),
                            Type = "Конференція",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 1, 5, 18, 44, 52, 363, DateTimeKind.Local).AddTicks(2620),
                            Type = "Стаття",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
