...
namespace Diploma.DataAccess.Migrations
{
    ...
    [Migration("20230105161343_update-publication")]
            ...
            modelBuilder.Entity("Diploma.DataAccess.Entities.PublicationType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 1, 5, 18, 13, 43, 61, DateTimeKind.Local).AddTicks(7711),
                            Type = "Конференція",
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 1, 5, 18, 13, 43, 61, DateTimeKind.Local).AddTicks(7743),
                            Type = "Стаття",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
