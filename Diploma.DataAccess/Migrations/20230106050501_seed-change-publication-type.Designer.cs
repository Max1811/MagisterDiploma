...
namespace Diploma.DataAccess.Migrations
{
    ...
    [Migration("20230106050501_seed-change-publication-type")]
    partial class seedchangepublicationtype
    {
            ...
            modelBuilder.Entity("Diploma.DataAccess.Entities.AuthorType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 1, 6, 7, 5, 1, 272, DateTimeKind.Local).AddTicks(5438),
                            Type = "Студент",
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 1, 6, 7, 5, 1, 272, DateTimeKind.Local).AddTicks(5442),
                            Type = "Викладач",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("Diploma.DataAccess.Entities.ConferenceType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 1, 6, 7, 5, 1, 272, DateTimeKind.Local).AddTicks(5458),
                            Type = "Всеукраїнська",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 1, 6, 7, 5, 1, 272, DateTimeKind.Local).AddTicks(5461),
                            Type = "Регіональна",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2023, 1, 6, 7, 5, 1, 272, DateTimeKind.Local).AddTicks(5463),
                            Type = "Міжнародна",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("Diploma.DataAccess.Entities.PublicationType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 1, 6, 7, 5, 1, 272, DateTimeKind.Local).AddTicks(5385),
                            Type = "Теза",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 1, 6, 7, 5, 1, 272, DateTimeKind.Local).AddTicks(5419),
                            Type = "Стаття",
                            UpdatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
